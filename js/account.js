(function() {
  ...
  function ensureStyles() {
    ...
    style.textContent =
      ...
      '.acct-btn{display:inline-flex;align-items:center;gap:6px;padding:8px 16px;border:2px solid rgba(255,255,255,.12);border-radius:10px;background:rgba(255,255,255,.06);color:#ccc;font-size:.85rem;font-weight:700;cursor:pointer;text-decoration:none}' +
      '.acct-btn:hover{border-color:#ffd700;color:#ffd700}'
